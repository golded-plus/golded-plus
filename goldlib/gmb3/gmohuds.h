...
template <class msgn_t, class rec_t, class attr_t, class board_t,
          class last_t> struct _HudsHdr
{
    msgn_t  msgno;
    msgn_t  replyto;
    msgn_t  reply1st;
...
template <class msgn_t, class rec_t, class attr_t, class board_t, class last_t,
          bool __HUDSON> struct _HudsWide
{
#if defined (GOLD_CANPACK)
#pragma pack(1)
#endif
...
//  ------------------------------------------------------------------
template <class msgn_t, class rec_t, class attr_t, class board_t, class last_t,
          bool __HUDSON> class _HudsArea : public gmo_area
{

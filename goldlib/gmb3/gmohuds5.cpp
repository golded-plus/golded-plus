                                                                   ...
                                                                   char * lng_head)
{
    ...
    Line * line = lin = AddLine(NULL,
                                __HUDSON ?
                                "Hexdump of " HUDS_NAME " message header and text" :
                                "Hexdump of " GOLD_NAME " message header and text");
    AddLineF(line,
             "------------------------------------------------------------------------------");
    line = AddLine(line, "");
    ...
    AddLineF(line, "NetAttr   : %02Xh (%sb)", _hdr.netattr, ltob(buf,
                                                                 _hdr.netattr,
                                                                 8));
    ...
    {
        AddLineF(line, "Board %03u-%03u : %10u %10u %10u %10u %10u", lrd + 1, lrd + 5,
                 (uint32_t)wide->lastrec[lrd + 0], (uint32_t)wide->lastrec[lrd + 1],
                 (uint32_t)wide->lastrec[lrd + 2], (uint32_t)wide->lastrec[lrd + 3],

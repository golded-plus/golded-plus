    ...
    if(fp.isopen())
    {
        ...
        if(*_fidopath)
        {
            ...
            if(fp.isopen())
            {
                ...
                if(fido_version == 2)
                {
                    ...
                    fp.Fread(&numrecs, 2);
                    numareas = numrecs;
                    areap    = (PcbFidoArea *)throw_calloc(1 + numrecs,
                                                           sizeof(PcbFidoArea));
                    fp.Fread(areap, sizeof(PcbFidoArea), numrecs);
                    // Skip archivers
                    fp.Fseek(sizeof(PcbFidoArchivers), SEEK_CUR);
                    // Get directories
                    dirp = (PcbFidoDirectories *)throw_calloc(1,
                                                              sizeof(PcbFidoDirectories));
                    ...
                    fp.Fread(&numrecs, 2);
                    akanumrecs = numrecs;
                    akap       = (PcbFidoAddress *)throw_calloc(1 + numrecs,
                                                                sizeof(PcbFidoAddress));
                ...
                else if(fido_version == 3)
                {
                    ...
                    if(fp.isopen())
                    {
                        ...
                        if(cfgver == 3)
                        {
                            ...
                            area3 = (PcbAreasDat *)throw_calloc(1 + numrecs,
                                                                sizeof(PcbAreasDat));
                    ...
                    if(fp.isopen())
                    {
                        ...
                        if(cfgver == 3)
                        {
                            ...
                            akanumrecs = numrecs;
                            aka3       = (PcbAkasDat *)throw_calloc(1 + numrecs,
                                                                    sizeof(PcbAkasDat));
                    ...
                    if(fp.isopen())
                    {
                        ...
                        if(cfgver == 3)
                        {
                            word numrecs = (word)(fp.FileLength() /
                                                  sizeof(PcbOriginsDat));
                            origin3 = (PcbOriginsDat *)throw_calloc(1 + numrecs,
                                                                    sizeof(PcbOriginsDat));
        ...
        if(fp.isopen())
        {
            ...
            if(fp2.isopen())
            {
                ...
                PcbAddConf * _cnamesadd = (PcbAddConf *)throw_calloc(1,
                                                                     sizeof(PcbAddConf));

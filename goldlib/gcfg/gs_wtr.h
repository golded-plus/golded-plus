...
typedef struct
{
    ...
    byte         fidonetmailtype;          // Netmail msgbase type: 0=None, 1=Msg, 2=Squish,
                                           // 3=Jam
    ...
    byte         uucpgateway;              // Gateway AKA nr: 1..10, as index in system AKAs
                                           // array
    ...
    bool logcopyheaders;                    // TRUE = Log headers that were copied from fido
                                            // netmail/echomail messages
    bool logillegalheaders;                 // TRUE = Log found headers that are not allowed
    bool logareafix;                        // TRUE = Log commands to / replyies from areafix /
                                            // newsfix
    ...
    char         adminfidoname[37];         // Full name of the administrator, for the Fidonet
                                            // address
    ...
    bool         adminsend2, adminsend3, adminsend4, adminsend5, adminsend6, adminsend7,
                 adminsend8, adminsend9, adminsend10, adminsend11, adminsend12,
                 adminsend13,
    ...
    bool  privatedecode;        // TRUE = scan and decode files from imported private scanned
                                // messages

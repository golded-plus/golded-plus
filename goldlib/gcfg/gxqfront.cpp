...
void gareafile::ReadQFront(char * tag)
{
    ...
    *path = NUL;
    ...
    OriginLineRecord * origin =
        (OriginLineRecord *)throw_calloc(1, sizeof(OriginLineRecord));
    ...
    EchoMailConferenceRecord * area =
        (EchoMailConferenceRecord *)throw_calloc(1, sizeof(EchoMailConferenceRecord));

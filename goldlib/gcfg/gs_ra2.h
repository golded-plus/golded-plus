...
struct USERSrecord
{
    ...
    /* Bit 0 : Hot-keys
           ...
           7 : Post bill enabled */
    FlagType       Flagsx;
    LongInt        Credit, Pending;
    Word           MsgsPosted, Security;
    LongInt        LastRead, NoCalls, Uploads, Downloads, UploadsK, DownloadsK, TodayK;
    Integer        Elapsed;
    Word           ScreenLength;
    Byte           LastPwdChange;
    Word           Group;
    ...
    Byte           ScreenWidth, Language, DateFormat;
    Char           ForwardTo[36];
    Word           MsgArea, FileArea;
...
struct MESSAGErecord
{
    ...
    Word     CountKill;
    Word     ReadSecurity;
    FlagType ReadFlags, ReadNotFlags;
    Word     WriteSecurity;
    FlagType WriteFlags, WriteNotFlags;
    Word     SysopSecurity;
    FlagType SysopFlags, SysopNotFlags;
    Char     OriginLine[61];
    Byte     AkaAddress;
    Byte     Age;
    Char     JAMbase[61];
...
struct CONFIGrecord
{
    ...
    Integer    xModemDelay;
    Word       MinimumBaud;
    Word       GraphicsBaud, TransferBaud;
    ra_Time    SlowBaudTimeStart, SlowBaudTimeEnd, DownloadTimeStart, DownloadTimeEnd;
    ra_Time    PageStart[7];
    ra_Time    PageEnd[7];
    Char       SeriNum[23];
    Char       CustNum[23];
    ...
    Char       Sysop[36];
    Char       LogFileName[61];
    Boolean    FastLogon, AllowSysRem, MonoMode, StrictPwdChecking, DirectWrite,
               SnowCheck;
    Integer CreditFactor;
    Word    UserTimeOut, LogonTime, PasswordTries, MaxPage, PageLength;
    Boolean CheckForMultiLogon, ExcludeSysopFromList, OneWordNames;
    AskType CheckMail;
    Boolean AskVoicePhone, AskDataPhone, DoFullMailCheck, AllowFileShells,
            FixUploadDates, FreezeChat;
    ...
    Byte           xUnknownArcAction, xFailedUnpackAction, FailedScanAction; /* Bit 0:Mark
                                                                                ...
                                                                                unlisted, 2:Mark
                                                                                notavail */
    Word           xUnknownArcArea, xFailedUnpackArea, FailedScanArea;
    Char           ScanCmd[61];
    ...
    Byte           NewuserSub;
    Char           PrinterName[5];
    Byte           HilitePromptFore, HiLitePromptBack;
    Char           xInitStr2[71];
    Boolean        AltJSwap;
    Char           SemPath[61];
    ...
    Byte           TagFore, TagBack;
    Char           xConnect16k[41];
    Byte           Exit16k, FilePayback;
    Char           FileLine[201];
    ...
    Char           xConnectFax[41];
    Byte           ExitFax;
    Boolean        UseXMS, UseEMS;
    Byte           CheckDOB;
    AskType        EchoCheck;
    Word           ccSec, ReturnRecSec;
    Boolean        HonourNetReq;
    COMBINEDrecord DefaultCombined;
    Boolean        AskForSex, AskForAddress;
    AskType        DLdesc;

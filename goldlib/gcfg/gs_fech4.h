...
typedef struct CONFIGURATION4
{
    ...
    char  NetMPath[_MAXPATH], MsgBase[_MAXPATH], InBound[_MAXPATH], OutBound[_MAXPATH],
          ...
          StatFile[_MAXPATH], SwapPath[_MAXPATH], SemaphorePath[_MAXPATH],
          BBSConfigPath[_MAXPATH], DBQueuePath[_MAXPATH], unused2[32], RetearTo[40],
          SecurePath[_MAXPATH], ExtAfter[_MAXPATH - 4], ExtBefore[_MAXPATH - 4];
    struct
    {
        char tag[4];

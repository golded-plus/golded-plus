...
extern const char * __re_compile_pattern(const char * pattern,
                                         size_t length,
...
extern int __re_search(struct re_pattern_buffer * buffer,
                       const char * string,
                       int length,
                       int start,
                       int range,
...
extern int __re_search_2(struct re_pattern_buffer * buffer,
                         const char * string1,
                         int length1,
                         const char * string2,
                         int length2,
...
extern int __re_match(struct re_pattern_buffer * buffer,
                      const char * string,
                      int length,
                      int start,
                      struct re_registers * regs);
...
extern int __re_match_2(struct re_pattern_buffer * buffer,
                        const char * string1,
                        int length1,
                        const char * string2,
                        int length2,
...
extern int regexec(const regex_t * __preg,
                   ...
                   regmatch_t __pmatch[],
                   int __eflags);
extern size_t __regerror(int __errcode,

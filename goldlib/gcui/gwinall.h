...
int wopen(int srow,
          ...
          vattr battr,
          vattr wattr,
          vattr sbattr = DEFATTR,
          vattr loattr = DEFATTR);

inline int wopen_(int srow,
                  int scol,
                  int vlen,
                  int hlen,
                  int btype,
...
{
    return vgetc(gwin.active->srow + wrow + gwin.active->border,
                 gwin.active->scol + wcol + gwin.active->border);
}

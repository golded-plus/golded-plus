...
static inline int isupvert(int btype, vchar ch)
{
    ...
    return (ch == LVL or ch == UHJ or ch == ULC or ch == URC or ch == LVJ or ch ==
            RVJ or ch == MJ) ? YES : NO;
}
...
static inline int isdownvert(int btype, vchar ch)
{
    ...
    return (ch == LVL or ch == LHJ or ch == LLC or ch == LRC or ch == LVJ or ch ==
            RVJ or ch == MJ) ? YES : NO;
}
...
static inline int islefthorz(int btype, vchar ch)
{
    ...
    return (ch == UHL or ch == LVJ or ch == LLC or ch == ULC or ch == UHJ or ch ==
            LHJ or ch == MJ) ? YES : NO;
}
...
static inline int isrighthorz(int btype, vchar ch)
{
    ...
    return (ch == UHL or ch == RVJ or ch == LRC or ch == URC or ch == UHJ or ch ==
            LHJ or ch == MJ) ? YES : NO;
}

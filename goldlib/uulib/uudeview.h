...
int UUEXPORT UUEncodeMulti(FILE *, FILE *, char *, int, char *, char *, int);
int UUEXPORT UUEncodePartial(FILE *,
                             FILE *,
                             char *,
                             int,
                             char *,
...
int UUEXPORT UUE_PrepSingle(FILE *,
                            FILE *,
                            char *,
                            int,
                            char *,
...
int UUEXPORT UUE_PrepPartial(FILE *,
                             ...
                             char *,
                             int);
int UUEXPORT UUE_PrepSingleExt(FILE *,
                               FILE *,
                               char *,
                               int,
                               char *,
                               ...
                               char *,
                               int);
int UUEXPORT UUE_PrepPartialExt(FILE *,
                                FILE *,
                                char *,
                                int,
                                char *,

...
protected:
    // Translate encoding:
    // flag=true: translate to charset of dictionnary, flag=false: translate to charset of
    // locale
...
private: bool SpellSuggest(const char * text, bool more);
...
private: void BuildRTable(const char * codeset);

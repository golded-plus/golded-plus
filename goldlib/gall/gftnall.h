...
bool invalid() const
{
    ...
    char * set(const char * str, char * dom = NULL,
               int domsizelimit = ftn::domain_limit);
    ...
    std::string & make_string(std::string & str,
                              const std::string & dom,
                              int domfmt = ftn::domain_last) const;
    char * make_string(char * str, const char * dom = NULL,
                       int domfmt = ftn::domain_last) const;
...
//  ------------------------------------------------------------------
inline ftn_addr::ftn_addr(uint zn, uint nt, uint nd, uint pt) : zone(0), net(0), node(0),
    point(0)
{
...
class ftn_akamatch
{
public: ftn_akamatch & operator =(const ftn_akamatch & o)
{
    mask = o.mask;
    aka  = o.aka;
    return *this;

...
int g_init_os(int flags)
{
    ...
    if(not rc)
    {
        ...
        rc = DosLoadModule((PSZ)ge_os2_loaderr,
                           sizeof(ge_os2_loaderr),
                           (PSZ)"PMWIN",
                           &ge_os2_hmte);
        ...
        if(flags & 1)
        {
            ...
            if(not rc)
            {
                ...
                if(not rc)
                {
                    DosQueryProcAddr(ge_os2_mdmHandle,
                                     0,
                                     (PSZ)"mciSendString",
                                     (PFN *)&pfnmciSendString);
                    DosQueryProcAddr(ge_os2_mdmHandle, 0, (PSZ)"mciGetErrorString",
        ...
        if(ge_os2_hsw)
        {
            ...
            pfnWinQueryWindowText(ge_os2_hwndframe,
                                  sizeof(ge_os2_coldtitle),
                                  ge_os2_coldtitle);
        }
    }
...
void g_deinit_os(void)
{
    if(ge_os2_hwndframe)
    {
        ...
        pfnWinSendMsg(ge_os2_hwndframe, WM_SETICON, (MPARAM)ge_os2_swolddata.hwndIcon,
                      (MPARAM)0);
    }

...
void ftn_golded_nodelist_index::fetchdata()
{
    ...
    if(currfileno != lastfileno)
    {
        ...
        if(currfileno != 0xff)
        {
            fhx = ::sopen(nodelist[currfileno].filename,
                          O_RDONLY | O_BINARY,
                          SH_DENYNO,
                          S_STDRD);
...
} // ftn_golded_nodelist_index::fetchdata
...
} // ftn_golded_nodelist_index::getnode
...
bool ftn_golded_nodelist_index::searchfirst()
{
    ...
    exactmatch = false;
    return false;
} // ftn_golded_nodelist_index::searchfirst
...
bool ftn_golded_nodelist_index::open()
{
    ...
    fha = ::sopen(AddPath(nlpath, "goldnode.gxa"),
                  O_RDONLY | O_BINARY,
                  SH_DENYNO,
                  S_STDRD);
    ...
    fhn = ::sopen(AddPath(nlpath, "goldnode.gxn"),
                  O_RDONLY | O_BINARY,
                  SH_DENYNO,
                  S_STDRD);
    ...
    isopen = true;
    return true;
} // ftn_golded_nodelist_index::open
...
void ftn_golded_nodelist_index::close()
{
    ...
    fhx    = -1;
    isopen = false;
} // ftn_golded_nodelist_index::close

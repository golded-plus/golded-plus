             ...
             ...)
{
...

    {
        ...
        /* _vsnprintf_s() may cause exception. Need to test before enabling.
         #   if __VISUAL_C_NOT_LESS(14,00)  // defined HAVE__VSTPRINTF_S // _vsnprintf_s()
         #recommended in MSDN
            ...
            if (ret < 0)
            {
              ...
              LOG.printf("! gsprintf()(buffer,%i,%s,...): _vsnprintf_s() error: \"%s\".",
               #sizeOfBuffer, format, strerror(errno));
              return -1;
            }
            buffer[sizeOfBuffer-1] = '\0';  // Microsoft implementation don't write final '\0'
             #if buffer full.
         #   elif __VISUAL_C_NOT_LESS(10,00)  // defined HAVE__VSTPRINTF // _vsnprintf() exist
         #in VS6 and deprecated in VS2005
         */

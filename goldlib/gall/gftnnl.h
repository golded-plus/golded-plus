...
{
public: ftn_addr addr;       // FTN 4D address, binary form
...
{
protected: ftn_nodelist_entry data;       // Nodelist data for current node
...
public: ftn_nodelist_index_base()
    {
        indexmax = indexpos = 0;
    }

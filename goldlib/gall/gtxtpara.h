...
#define MK_CHR4(a, b, c, \
                d) ((dword)(a) | ((dword)(b) << 8) | ((dword)(c) << 16) | ((dword)(d) << \
                                                                           24))
//  ------------------------------------------------------------------
...
enum
{
    ...
    CTRL_AREA, CTRL_TEARLINE, CTRL_ORIGIN,
    // Standard known kludges
    CTRL_KLUDGE, CTRL_INTL, CTRL_FMPT, CTRL_TOPT, CTRL_MSGID, CTRL_REPLY, CTRL_PID,
    CTRL_SEENBY, CTRL_SEENBY1, CTRL_PATH, CTRL_CHARSET, CTRL_CHRS, CTRL_TZUTC, CTRL_VIA,
    CTRL_FLAGS,
    // Unknown kludges
    CTRL_UNKNOWNKLUDGE
};

...
//  Add path to filename if no path is present. Uses static string and don't chech size of
// 'path', be careful!
...
#if !defined (__DJGPP__) && ((defined (__BORLANDC__) && defined (__OS2__)) || \
    defined (__UNIX__) || defined (__EMX__))
...
#if !defined (sopen) && !defined (__MINGW32__) && !defined (__EMX__) && \
    !defined (__QNXNTO__) && defined (__GNUC__)

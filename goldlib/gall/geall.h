...
enum
{
    TAG_MARKYOURMAIL = 100, TAG_MARKHEADER, TAG_MARKTXTHDR, TAG_MARKTHREAD,
    TAG_MARKASREAD, TAG_MARKNEWMSGS, TAG_MARKOLDMSGS, TAG_MARKALLMSGS, TAG_MARKUNMARK,
    TAG_MARKRANGE, TAG_MARKTOGGLE, TAG_MARKQUIT
};

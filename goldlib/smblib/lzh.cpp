...
#define LFREE free
#define FREE free
#endif // if defined (__COMPACT__) || defined (__LARGE__) || defined (__HUGE__)
/* LZSS Parameters */
...
int16_t lzh_match_position, lzh_match_length, * lzh_lson, * lzh_rson, * lzh_dad;

#else

uint8_t lzh_text_buf[LZH_N + LZH_F - 1];
int16_t lzh_match_position, lzh_match_length, lzh_lson[LZH_N + 1], lzh_rson[LZH_N + 257],
        lzh_dad[LZH_N + 1];
...
void lzh_insert_node(int16_t r)
{
    ...
    for( ; ; )
    {
        ...
        if(i > LZH_THRESHOLD)
        {
            ...
            if(i == lzh_match_length)
            {
                if((c = ((r - p) & (LZH_N - 1)) - 1) < (uint32_t)lzh_match_position)
                {
...
{0x03,    0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06,
 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x07, 0x07, 0x07, 0x07,
 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07,
 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08,
...
{0x00,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
 ...
 , };
uint8_t lzh_d_len[256] =
{0x03,    0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03,
 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03,
 0x03, 0x03, 0x03, 0x03, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04,
 ...
 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,
 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05,
 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
    ...
    do
    {
        ...
        else
        {
            lzh_encode_char((uint16_t)(255 - LZH_THRESHOLD + lzh_match_length),
                            outbuf,
                            &outlen);
            lzh_encode_position(lzh_match_position, outbuf, &outlen);
        }
...
int32_t LZHCALL lzh_decode(uint8_t * inbuf, int32_t inlen, uint8_t * outbuf)
{
    ...
    for(count = 0; count < (uint32_t)textsize; )
    {
        ...
        {
            i = (r - lzh_decode_position(inbuf, &incnt, inlen) - 1) & (LZH_N - 1);

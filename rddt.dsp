...
# ADD LINK32 winmm.lib user32.lib Release\*.obj /nologo /subsystem:console /machine:I386 /out:"Release/rddtwin.exe"
...
# ADD LINK32 winmm.lib user32.lib Debug\*.obj /nologo /subsystem:console /debug /machine:I386 /out:"Debug/rddtwin.exe" /pdbtype:sept
...
# PROP Intermediate_Dir "Release\rddt\"

!ELSEIF  "$(CFG)" == "rddt - Win32 Debug"

# PROP Intermediate_Dir "Debug\rddt\"

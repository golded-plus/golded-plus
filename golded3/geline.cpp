...
enum
{
    MASK_FTS = 0x1000, FTS_AREA, FTS_INTL, FTS_FMPT, FTS_TOPT, FTS_MSGID, FTS_REPLY,
    FTS_SEENBY, FTS_PATH, FTS_ZZZZ
};

enum
{
    MASK_FSC = 0x2000, FSC_CHARSET, FSC_CHRC, FSC_CHRS, FSC_CODEPAGE, FSC_DOMAIN,
    FSC_EID, FSC_ENC, FSC_ENCLFILE, FSC_FLAGS, FSC_FWDFROM, FSC_FWDORIG, FSC_FWDTO,
    FSC_FWDDEST, FSC_FWDSUBJ, FSC_FWDAREA, FSC_FWDMSGID, FSC_I51, FSC_MSGTO, FSC_PID,
    FSC_PTH, FSC_REPLYADDR, FSC_REPLYTO, FSC_SPLIT, FSC_SPTH, FSC_TID, FSC_ZZZZ
};

enum
{
    MASK_XXX = 0x8000, XXX_ACUPDATE, XXX_DESTADDR, XXX_ENCRYPTION, XXX_EOT, XXX_GATECHK,
    XXX_GID, XXX_GIF, XXX_GMD, XXX_GROUP, XXX_MOOD, XXX_MSGSEQ, XXX_NOTE, XXX_ORIGID,
    XXX_ORIGINAL, XXX_ORIGREF, XXX_RECD, XXX_RFC, XXX_RFD, XXX_RID, XXX_ROUTE, XXX_SN,
    XXX_SOT, XXX_TCL1, XXX_TCL2, XXX_TZUTCINFO, XXX_TZUTC, XXX_TZ, XXX_VIA, XXX_XID,
    XXX_ZZZZ
};

enum
{
    MASK_RFC = 0x4000, RFC_ALSO_CONTROL, RFC_APPARENTLY_TO, RFC_APPROVED,
    RFC_ARTICLE_NAMES, RFC_ARTICLE_UPDATES, RFC_BCC, RFC_CC, RFC_COMMENT, RFC_COMMENTS,
    RFC_CONTENT_DESCRIPTION, RFC_CONTENT_DISPOSITION, RFC_CONTENT_ID, RFC_CONTENT_LENGTH,
    RFC_CONTENT_TRANSFER_ENCODING, RFC_CONTENT_TYPE, RFC_CONTROL, RFC_DATE,
    RFC_DELIVERED_TO, RFC_DELIVERY_DATE, RFC_DISTRIBUTION, RFC_ENCRYPTED, RFC_ERRORS_TO,
    RFC_EXPIRES, RFC_FOLLOWUP_TO, RFC_FROM, RFC_FROMX, RFC_IN_REPLY_TO, RFC_KEYWORDS,
    RFC_LINES, RFC_MAILING_LIST,      // This one is actually _not_ RFC
    RFC_MESSAGE_ID, RFC_MIME_VERSION, RFC_NEWSGROUPS, RFC_NEWS_SOFTWARE,
    RFC_NNTP_POSTING_DATE, RFC_NNTP_POSTING_HOST, RFC_NNTP_POSTING_USER, RFC_OLD_DATE,
    RFC_ORGANIZATION, RFC_ORIGINATOR, RFC_PATH, RFC_PRECEDENCE, RFC_PRIORITY,
    RFC_RECEIVED, RFC_REFERENCES, RFC_REPLY_TO, RFC_RETURN_PATH, RFC_RETURN_RECEIPT_TO,
    RFC_SEE_ALSO, RFC_SENDER, RFC_STATUS, RFC_SUBJECT, RFC_SUMMARY, RFC_SUPERSEDES,
    RFC_TO, RFC_VERSION, RFC_XREF, RFC_X_CHARSET, RFC_X_CHAR_ESC, RFC_X_FTN_TO,
    RFC_X_MAILER, RFC_X_NEWSREADER, RFC_X_TO, RFC_RNEWS, RFC_ZZZZ
};
...
{   {"ACUPDATE",   XXX_ACUPDATE,
     KCRQ_CASE                                                        },
    {"DESTADDR",   XXX_DESTADDR,
     KCRQ_CASE                                                        },
    {"ENCRYPTION", XXX_ENCRYPTION,
     KCRQ_CASE                                                        },
    {"EOT",        XXX_EOT,
     KCRQ_CASE                                                        },
    {"GATECHK",    XXX_GATECHK,
    ...
    {"TZ",         XXX_TZ,
     KCRQ_CASE                                                        },
    {"Via",        XXX_VIA,
     KCRQ_NONE                                                        },{"XID", XXX_XID,  KCRQ_CASE   },
    {"",           XXX_ZZZZ,
     KCRQ_NONE                                                        }
};
//  ------------------------------------------------------------------
static const Kludges rfc_list[] =
{   {"Also-Control",              RFC_ALSO_CONTROL,
     KCRQ_COLON                       },
    {"Apparently-To",             RFC_APPARENTLY_TO,
     KCRQ_COLON                       },
    {"Approved",                  RFC_APPROVED,
     KCRQ_COLON                       },
    {"Article-Names",             RFC_ARTICLE_NAMES,
     KCRQ_COLON                       },
    {"Article-Updates",           RFC_ARTICLE_UPDATES,
     KCRQ_COLON                       },
    {"Bcc",                       RFC_BCC,
     KCRQ_COLON                       },
    {"Cc",                        RFC_CC,
    ...
    {"Comment",                   RFC_COMMENT,
     KCRQ_COLON                       },
    {"Comments",                  RFC_COMMENTS,
     KCRQ_COLON                       },
    {"Content-Description",       RFC_CONTENT_DESCRIPTION,
     KCRQ_COLON                       },
    {"Content-Disposition",       RFC_CONTENT_DISPOSITION,
     KCRQ_COLON                       },
    {"Content-ID",                RFC_CONTENT_ID,
     KCRQ_COLON                       },
    {"Content-Length",            RFC_CONTENT_LENGTH,
     KCRQ_COLON                       },
    {"Content-Transfer-Encoding", RFC_CONTENT_TRANSFER_ENCODING,
     KCRQ_COLON                       },
    {"Content-Type",              RFC_CONTENT_TYPE,
     KCRQ_COLON                       },
    {"Control",                   RFC_CONTROL,
     KCRQ_COLON                       },
    {"Date",                      RFC_DATE,
     KCRQ_COLON                       },
    {"Delivered-To",              RFC_DELIVERED_TO,
     KCRQ_COLON                       },
    {"Delivery-Date",             RFC_DELIVERY_DATE,
     KCRQ_COLON                       },
    {"Distribution",              RFC_DISTRIBUTION,
     KCRQ_COLON                       },
    {"Encrypted",                 RFC_ENCRYPTED,
     KCRQ_COLON                       },
    {"Errors-To",                 RFC_ERRORS_TO,
     KCRQ_COLON                       },
    {"Expires",                   RFC_EXPIRES,
     KCRQ_COLON                       },
    {"Followup-To",               RFC_FOLLOWUP_TO,
     KCRQ_COLON                       },
    {"From",                      RFC_FROM,
     KCRQ_COLON                       },
    {"From",                      RFC_FROMX,
     KCRQ_NONE                        },
    {"In-Reply-To",               RFC_IN_REPLY_TO,
     KCRQ_COLON                       },
    {"Keywords",                  RFC_KEYWORDS,
     KCRQ_COLON                       },
    {"Lines",                     RFC_LINES,
     KCRQ_COLON                       },
    {"Message-ID",                RFC_MESSAGE_ID,
     KCRQ_COLON                       },
    {"Mailing-List",              RFC_MAILING_LIST,
     KCRQ_COLON                       },
    {"MIME-Version",              RFC_MIME_VERSION,
     KCRQ_COLON                       },
    {"Newsgroups",                RFC_NEWSGROUPS,
     KCRQ_COLON                       },
    {"News-Software",             RFC_NEWS_SOFTWARE,
     KCRQ_COLON                       },
    {"NNTP-Posting-Date",         RFC_NNTP_POSTING_DATE,
     KCRQ_COLON                       },
    {"NNTP-Posting-Host",         RFC_NNTP_POSTING_HOST,
     KCRQ_COLON                       },
    {"NNTP-Posting-User",         RFC_NNTP_POSTING_USER,
     KCRQ_COLON                       },
    {"Old-Date",                  RFC_OLD_DATE,
     KCRQ_COLON                       },
    {"Organization",              RFC_ORGANIZATION,
     KCRQ_COLON                       },
    {"Originator",                RFC_ORIGINATOR,
     KCRQ_COLON                       },
    {"Path",                      RFC_PATH,
     KCRQ_COLON                       },
    {"Precedence",                RFC_PRECEDENCE,
     KCRQ_COLON                       },
    {"Priority",                  RFC_PRIORITY,
     KCRQ_COLON                       },
    {"Received",                  RFC_RECEIVED,
     KCRQ_COLON                       },
    {"References",                RFC_REFERENCES,
     KCRQ_COLON                       },
    {"Reply-To",                  RFC_REPLY_TO,
     KCRQ_COLON                       },
    {"Return-Path",               RFC_RETURN_PATH,
     KCRQ_COLON                       },
    {"Return-Receipt-To",         RFC_RETURN_RECEIPT_TO,
     KCRQ_COLON                       },
    {"See-Also",                  RFC_SEE_ALSO,
     KCRQ_COLON                       },
    {"Sender",                    RFC_SENDER,
     KCRQ_COLON                       },
    {"Status",                    RFC_STATUS,
    ...
    {"Xref",                      RFC_XREF,
     KCRQ_COLON                       },
    {"X-Charset",                 RFC_X_CHARSET,
     KCRQ_COLON                       },
    {"X-Char-Esc",                RFC_X_CHAR_ESC,
     KCRQ_COLON                       },
    {"X-FTN-To",                  RFC_X_FTN_TO,
     KCRQ_COLON                       },
    {"X-Mailer",                  RFC_X_MAILER,
     KCRQ_COLON                       },
    {"X-Mailreader",              RFC_X_MAILER,
     KCRQ_COLON                       },
    {"X-Newsreader",              RFC_X_NEWSREADER,
     KCRQ_COLON                       },
    {"X-To",                      RFC_X_TO,
     KCRQ_COLON                       },
    {"#!",                        RFC_RNEWS,
...
//  ------------------------------------------------------------------
static int HandleKludges(GMsg * msg,
                         Line * line,
                         int kludgenum,
                         const char * ptr,
                         int getvalue)
...
int ScanLine(GMsg * msg, Line * line, const char * ptr, int getvalue, int mask)
{
    ...
    else
    {
        ...
        {
            if((strnieql(kludge, "X-", 2) or strnieql(kludge, "Resent-",
                                                      7)) and (endchar ==
                                                               ':') and (mask &
                                                                         MASK_RFC))
            {
...
void ScanKludges(GMsg * msg, int getvalue)
{
    ...
    do
    {
        ...
        {
            if(strneql(ptr, "AREA:",
                       5) and (line->prev == NULL or * line->prev->txt.c_str() ==
                               CTRL_A))
            {
                line->color  = C_READK;
                line->kludge = GKLUD_AREA;
            ...
            if(not (line->type & GLINE_KLUD))
            {
                ...
                if(not gottag and (strneql("...", ptr, 3) or strneql("___", ptr, 3)))
                {
                    ...
                    if(not lineno or ((lineno - 1) == tearlineno) or ((lineno - 1) ==
                                                                      originlineno))
                    {
                        gottag      = YES;
                        ...
                        {
                            strbtrim(strxcpy(msg->tagline, ptr + 3,
                                             sizeof(msg->tagline)));
                        }
                    }
                }
                // Check if it's a tearline
                else if(not (gottear or gottag) and strneql("---", ptr,
                                                            3) and (ptr[3] ==
                                                                    ' ' or ptr[3] ==
                                                                    NUL))
                {
                    ...
                    if(not tearlnno or ((tearlnno - 1) ==
                                        originlineno) or not nnel or nnel->type &
                       GLINE_KLUDGE)
                    {
                        // Found Tearline
                        gottear    = YES;
                        ...
                        for(tearln = line; tearln->type & GLINE_WRAP;
                            tearln = tearln->next)
                        {
                        ...
                        {
                            char * tearid[] =
                            {"GoldED",   " GED ",      " GED2 ",      " GED3 ",
                             " GED386 ",
                             " GED/2 ",  " GED/386 ",  " GEDP16 ",    " GEDP32 ",
                             " GEDW32 ", " GEDLNX ",   " GED/W32 ",   NULL};
                            int n = 0;
                ...
                else if(not (gotorig or gottear or gottag) and strneql(" * Origin: ",
                                                                       ptr, 11))
                {
                    // Found Origin line
                    ...
                    bool nextor =
                        cnd ? (not nnel or nnel->type &
                               GLINE_KLUDGE) and (line->next->txt.find(/*(*/ ')') !=
                                                  line->next->txt.npos) : false;
                ...
                if(iconv_cd != (iconv_t)(-1))
                {
                    ...
                    if(iconvrc == ((size_t)-1))
                    {
                        switch(errno)
                        {
                            case EINVAL:
                                LOG.printf(
                                    "An incomplete multibyte sequence has been encountered before:");
                                LOG.printf("%s", sptr);

                            case EILSEQ:
                                LOG.printf(
                                    "An invalid multibyte sequence has been encountered in the input before:");
                                LOG.printf("%s", sptr);

                            case E2BIG:
                                LOG.printf(
                                    "There is not sufficient destination size before '%s'",
                                    sptr);

                            default:
                                LOG.printf("Unknown error %u in iconv() before %s",
                                           errno,
                                           sptr);
                        }
                    }
...
{
    if((*ptr == CR) or (*ptr ==
                        CTRL_A) or is_quote(ptr) or ((ptr[0] == ptr[1]) and (ptr[0] ==
                                                                             ptr[2])) or (
           strneql(ptr, "-- ", 3) and (ptr[3] == CR)) or strneql(ptr,
                                                                 " * Origin: ",
                                                                 11) /*or
                                                                        (ptr[0] == prev_ptr[0])
                                                                           and (ptr[1] ==
...
void MakeLineIndex(GMsg * msg, int margin, bool getvalue, bool header_recode)
{
    ...
    bool qpencoded     =
        getvalue and (IsQuotedPrintable(AA->Xlatimport()) or AA->StripHTML());
    bool gotmime      = false;
        ...
        if(*ptr != NUL)
        {
            ...
            while(*ptr)
            {
                ...
                if(line->prev)
                {
                    ...
                    if((line->prev->type & (GLINE_HARD | GLINE_WRAP | GLINE_QUOT)) ==
                       (GLINE_HARD | GLINE_WRAP))
                    {
                ...
                if(wraps == 0)
                {
                    if(gotmultipart)
                    {
                        if(*ptr == '-' and ptr[1] == '-')
                        {
                            ...
                            for(ib = boundary_set.begin(); ib != boundary_set.end();
                                ib++)
                            {
                    ...
                    if(*ptr == CTRL_A or inheader) // Found kludge/hidden line
                    {
                        ...
                        if(getvalue and not CFG->ignorecharset)
                        {
                            ...
                            *ptr = NUL;
                            ...
                            else if(strieql(kludge, "CHRS") or strieql(kludge,
                                                                       "CHARSET"))
                            {
                            ...
                            *ptr = endchar;
                            ...
                            else if((kludgetype == FSC_CHARSET) or (kludgetype ==
                                                                    FSC_CODEPAGE))
                            {
                                *chsbuf   = NUL;
                                ...
                                {
                                    strxcpy(chsbuf,
                                            qpencoded ? ExtractPlainCharset(ptr) : ptr,
                                            sizeof(chsbuf));
                                }

                                // Workaround for buggy mailreaders which stores '_' in charset
                                // name
                                strchg(chsbuf, '_', ' ');
                                chslev = LoadCharset(chsbuf, CFG->xlatlocalset);
                            ...
                            else if(kludgetype == RFC_CONTENT_TRANSFER_ENCODING)
                            {
                                if(striinc("quoted-printable", ptr))
                                {
                                    ...
                                    chslev =
                                        LoadCharset(msg->charset, CFG->xlatlocalset);
                ...
                while(*ptr and (len < (uint)margin))
                {
                    switch(*ptr)
                    {
                        ...
                        do_cr: ch = CR;
                            ...
                            if(wraps and not ((line->type &
                                               GLINE_HARD) and not (line->type &
                                                                    GLINE_QUOT)))
                            {
                                if(para != GLINE_QUOT)
                                {
                        ...
                        do_ht:
                            ...
                            if(CFG->disptabsize)
                            {
                                ...
                                for(n = 0;
                                    n < (CFG->disptabsize - (llen % CFG->disptabsize));
                                    n++)
                                {
                                    *(++bp) = ' ';
                                    len++;
                ...
                *(++bp) = NUL;
                ...
                if(tmplinelength > (uint)(margin + 512))
                {
                    LOG.ErrPointer();
                    LOG.printf(
                        "! A message line length (%u bytes) exceeded an internal buffer limit of %u bytes",
                        tmplinelength,
                        margin + 512);
            ...
            // From: fido7@da.ru
            if(getvalue and streql(msg->by,
                                   msg->iaddr) and not * msg->realby and * msg->igate)
            {
...
void MsgLineReIndex(GMsg * msg, int viewhidden, int viewkludge, int viewquote)
{
    ...
    while(line)
    {
        ...
        if(line->next)
        {
            if(line->type & GLINE_QUOT)
            {
                if(not (line->next->type &
                        GLINE_QUOT) and not strblank(line->next->txt.c_str()))
                {
...
{
    static const char * isono[] =
    {"15", "1", "2", "3", "4", "9", "10", "13", "14", "15"};
    int chsno = atoi(latin_encoding + 5);

    if(chsno < 0)
    {
        chsno = -chsno;         // support for both latin-1 and latin1
    }
...
{
    static const char * latinno[] =
    {NULL, "1", "2", "3", "4", NULL, NULL, NULL, NULL, "5", "6", NULL, NULL, "7", "8",
     "9"};
...
int LoadCharset(const char * imp, const char * exp, int query)
{
    ...
    for(n = 0, xlt = CFG->xlatcharset.begin(); xlt != CFG->xlatcharset.end(); xlt++, n++)
    {
        ...
        if(imp_found)
        {
            imp_found = CheckLevel(imp, xlt->imp, n, current_table);
        }
            ...
            !imp_found && (als != CFG->xlatcharsetalias.end()); als++)
        {
            ...
            {
                for(gstrarray::iterator it = als->second.begin();
                    !imp_found && (it != als->second.end()); it++)
                {
                         ...
                         bool detect_charset)
{
    *__name = *__addr = NUL;
    ...
    if(*endchar == /*(*/ ')')
    {
        ...
        strbtrim(strxcpy(__name, begchar,
                         MinV((size_t)(endchar - begchar) + 1, (size_t)sizeof(INam))));
        strbtrim(strxcpy(__addr, __string,
                         MinV((size_t)(begchar - __string), (size_t)sizeof(IAdr))));
    }
    else if(*endchar == '>')
    {
        ...
        strbtrim(strxcpy(__name, __string,
                         MinV((size_t)(endchar - __string) + 1, (size_t)sizeof(INam))));
        strbtrim(strxcpy(__addr, begaddr,
                         MinV((size_t)(endaddr - begaddr) + 1, (size_t)sizeof(IAdr))));
    }
    else
    {
...
void InvalidateControlInfo(GMsg * msg)
{
    ...
    while(line)
    {
        if(not (line->type & (GLINE_TEAR | GLINE_ORIG)))
        {
            ...
            {
                doinvalidate(buf,
                             CFG->invalidate.tearline.first.c_str(),
                             CFG->invalidate.tearline.second.c_str(),
                             true);
            }
            else
            {
            ...
            {
                doinvalidate(buf,
                             CFG->invalidate.origin.first.c_str(),
                             CFG->invalidate.origin.second.c_str());
            }
            else
            {
            ...
            {
                doinvalidate(buf,
                             CFG->invalidate.seenby.first.c_str(),
                             CFG->invalidate.seenby.second.c_str());
            }
            else
            {

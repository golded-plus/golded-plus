...
int TemplateToText(int mode, GMsg * msg, GMsg * oldmsg, const char * tpl, int origarea)
{
    ...
    {   {CSTR_COMMA_SIZEOF_CSTR("forward")   }, {CSTR_COMMA_SIZEOF_CSTR("notforward")  },
        {CSTR_COMMA_SIZEOF_CSTR("changed")   }, {CSTR_COMMA_SIZEOF_CSTR("net")         },
        {CSTR_COMMA_SIZEOF_CSTR("echo")      }, {CSTR_COMMA_SIZEOF_CSTR("local")       },
        {CSTR_COMMA_SIZEOF_CSTR("moved")     }, {CSTR_COMMA_SIZEOF_CSTR("new")         },
        {CSTR_COMMA_SIZEOF_CSTR("reply")     }, {CSTR_COMMA_SIZEOF_CSTR("quoted")      },
        {CSTR_COMMA_SIZEOF_CSTR("comment")   }, {CSTR_COMMA_SIZEOF_CSTR("quotebuf")    },
        {CSTR_COMMA_SIZEOF_CSTR("attrib")    }, {CSTR_COMMA_SIZEOF_CSTR("spellchecker")},
        {CSTR_COMMA_SIZEOF_CSTR("setsubj")   }, {CSTR_COMMA_SIZEOF_CSTR("setfrom")     },
        {CSTR_COMMA_SIZEOF_CSTR("setto")     }, {CSTR_COMMA_SIZEOF_CSTR("forcesubj")   },
        {CSTR_COMMA_SIZEOF_CSTR("forcefrom") }, {CSTR_COMMA_SIZEOF_CSTR("forceto")     },
        {CSTR_COMMA_SIZEOF_CSTR("xlatexport")}, {CSTR_COMMA_SIZEOF_CSTR("loadlanguage")},
        {CSTR_COMMA_SIZEOF_CSTR("random")    }, {CSTR_COMMA_SIZEOF_CSTR("quote")       },
        {CSTR_COMMA_SIZEOF_CSTR("include")   }, {CSTR_COMMA_SIZEOF_CSTR("message")     },
        {CSTR_COMMA_SIZEOF_CSTR("moderator") }, {CSTR_COMMA_SIZEOF_CSTR("write")       },
 ...
 */
    ...
    if(is_user(msg->By()))
    {
        strcpy(msg->pseudofrom,
               *AA->Nickname() ? AA->Nickname() : strlword(msg->By(), " @."));
    }
    else
    {
        *(msg->pseudofrom) = NUL;
                ...
                if(token < end_token)
                {
                    ...
                    switch(token)
                    {
                        ...
                        case TPLTOKEN_MOVED:
                            ...
                            if(AL.AreaIdToPtr(origarea)->Areareplydirect() and oldmsg->
                               areakludgeid and strieql(oldmsg->areakludgeid,
                                                        AA->echoid()))
                            {
                                goto loop_next;
                            }

                            if(AL.AreaIdToPtr(origarea)->Areareplydirect() and strieql(AL
                                                                                       .
                                                                                       AreaIdToPtr(
                                                                                           origarea)
                                                                                       ->

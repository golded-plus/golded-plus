...
void GMsgHeaderView::Paint()
{
    ...
    strxmerge(top,
              ...
              " (",
              area->isinternet() ? area->Internetaddress() :
    ...
    vattr color = ((msg->foundwhere &
                    GFIND_FROM) or msg->attr.fmu() or (msg->attr.loc() and CFG->switches.
                                                       get(displocalhigh))) ?
                  highlight_color : from_color;
    ...
    color = ((msg->foundwhere &
              GFIND_TO) or msg->attr.tou()) ? highlight_color : to_color;
    {
        Addr zero;

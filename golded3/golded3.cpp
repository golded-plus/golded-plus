...
#define __GVER_LONGPID__ __GVER_PRENAME__ __GVER_NAME__ __GVER_POSTNAME__ \
    __GVER_PLATFORM__
#define __GVER_SHORTPID__ __GVER_PRESHORTNAME__ __GVER_SHORTNAME__ __GVER_POSTSHORTNAME__ \
    __GVER_SHORTPLATFORM__
#define __GVER_VER__(A, B, \
                     C) __GVER_PREVERSION__#A "."#B "."#C __GVER_POSTVERSION__ __SO__ \
    __SRCDATE__ __SC__
...
#define __GVER__(__GVER_MAJOR__, __GVER_MINOR__, __GVER_RELEASE__) \
    ...
    const char * __gver_ver__      = __GVER_VER__(__GVER_MAJOR__, \
                                                  __GVER_MINOR__, \
                                                  __GVER_RELEASE__); \
    const char * __gver_shortver__ = __GVER_SVER__(__GVER_MAJOR__, \
                                                   __GVER_MINOR__, \
                                                   __GVER_RELEASE__);
//  ------------------------------------------------------------------
//  Product name.
